...
# Instancio los arreglos para los datos
  ...
  cant_datos = cant_datos_semana_2003 + cant_datos_semana_2004 + cant_datos_semana_2005 + cant_datos_semana_2006 + cant_datos_semana_2007 + cant_datos_semana_2008
  datos = datos_semana_2003 + datos_semana_2004 + datos_semana_2005 + datos_semana_2006 + datos_semana_2007 + datos_semana_2008
...
# Debería haber cantidad de años-1 
  ...
  plt.plot(x, cant_datos, 'ro', 
           ...
           linestyle='-',
           color='b',
           label=u"Cantidad de delay de seguridad por semana")
  ...
  plt.legend()
  plt.savefig('./graficos/grafico_cantidad_delay_semana_seguridad')
  plt.show()
  ...
  plt.plot(x, datos, 'ro', 
           ...
           linestyle='-',
           color='b',
           label=u"Delay de seguridad por semana")

  plt.xlabel(u"Semanas")
  plt.ylabel(u"Delays")
  plt.xticks([24+12*i*4 for i in range(0,6)],['2003', '2004', '2005', '2006', '2007', '2008'],fontsize=10)
  plt.legend()
  plt.savefig('./graficos/grafico_delay_semana_seguridad')
  plt.show()
