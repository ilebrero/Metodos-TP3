...
def graficarMesDelay(directory, airport, delay_filter, data):
...
# Debería haber cantidad de años-1 
  ...
  plt.legend()
  plt.savefig(directory + '/graficos/grafico_cantidad_delay_mes')
  plt.show()
  ...
  plt.xticks([6+12*i for i in range(0,11)],['1998', '1999', '2000', '2001', '2002', '2003', '2004', '2005', '2006', '2007', '2008'],fontsize=10)
  plt.legend()
  plt.savefig(directory + '/graficos/grafico_delay_mes')
  plt.show()
  ...
  if delay_filter != '':
    ...
    if delay_filter == 24:
      ...
      fig = directory + '/graficos/grafico_cantidad_delays_carrier_mes'
      fig_f = directory + '/graficos/grafico_delays_carrier_mes'

    if delay_filter == 25:
      lab = "Cantidad de delays de clima por mes"
      lab_f = "Delays de clima por mes"
      fig = directory + '/graficos/grafico_cantidad_delays_clima_mes'
      fig_f = directory + '/graficos/grafico_delays_clima_mes'

    if delay_filter == 26:
      lab = "Cantidad de delays de NAS por mes"
      lab_f = "Delays de NAS por mes"
      fig = directory + '/graficos/grafico_cantidad_delays_NAS_mes'
      fig_f = directory + '/graficos/grafico_delays_NAS_mes'

    if delay_filter == 27:
      lab = "Cantidad de delays de seguridad por mes"
      lab_f = "Delays de seguridad por mes"
      fig = directory + '/graficos/grafico_cantidad_delays_seguridad_mes'
      fig_f = directory + '/graficos/grafico_delays_seguridad_mes'
