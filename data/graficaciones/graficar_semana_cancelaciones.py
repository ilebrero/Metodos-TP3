...
def func(x, a, b, c):
  return c*(np.abs(np.cos(x*12))) + a + b
...
# Instancio los arreglos para los datos
  ...
  for i in range (inicioAno, finAno+1):
    cancelaciones = cancelaciones + cancelaciones_2004 + cancelaciones_2005 + cancelaciones_2006 + cancelaciones_2007 + cancelaciones_2008

    cancelaciones_filtro = cancelaciones_filtro + anos_filtro[str(i)]
