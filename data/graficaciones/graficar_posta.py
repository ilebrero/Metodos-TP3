...
def graficarPosta(directory, airport, an, delay_filter, data):
...
#       print eje_x3['x_domingo_' + str(h)]
    ...
    if j == 0:
      directory = directory + '/graficos_2004'

    if not os.path.exists(directory):
      os.mkdir(directory)

    print directory + '/' + meses[11] + "_" + meses[0] + "_" + meses[1] + "_2004"
    if j == 0:
      plt.savefig(directory + '/' + meses[11] + "_" + meses[0] + "_" + meses[1] + "_2004")
    else:
      plt.savefig(directory + '/' + meses[3*j-1] + "_" + meses[3*j] + "_" + meses[3*j+1] + "_2004")
