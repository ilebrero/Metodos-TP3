...
def graficarMesCancelaciones2(directory_1, directory_2, airport_1, airport_2, cancelation_code):
...
# Instancio los arreglos para los datos
  ...
  file_out_1 = directory_1 + '/' + airport_1

  readFile(file_out_1 + '1998.csv', cancelaciones1_1998, cancelaciones1_filtro_1998, cancelation_code)
  readFile(file_out_1 + '1999.csv', cancelaciones1_1999, cancelaciones1_filtro_1999, cancelation_code)
  readFile(file_out_1 + '2000.csv', cancelaciones1_2000, cancelaciones1_filtro_2000, cancelation_code)
  readFile(file_out_1 + '2001.csv', cancelaciones1_2001, cancelaciones1_filtro_2001, cancelation_code)
  readFile(file_out_1 + '2002.csv', cancelaciones1_2002, cancelaciones1_filtro_2002, cancelation_code)
  readFile(file_out_1 + '2003.csv', cancelaciones1_2003, cancelaciones1_filtro_2003, cancelation_code)
  readFile(file_out_1 + '2004.csv', cancelaciones1_2004, cancelaciones1_filtro_2004, cancelation_code)
  readFile(file_out_1 + '2005.csv', cancelaciones1_2005, cancelaciones1_filtro_2005, cancelation_code)
  readFile(file_out_1 + '2006.csv', cancelaciones1_2006, cancelaciones1_filtro_2006, cancelation_code)
  readFile(file_out_1 + '2007.csv', cancelaciones1_2007, cancelaciones1_filtro_2007, cancelation_code)
  readFile(file_out_1 + '2008.csv', cancelaciones1_2008, cancelaciones1_filtro_2008, cancelation_code)

  years_1 = 11
  x_1 = []
  y_1 = []

  for i in range(0, years_1):
    for j in range(1, 13):
      x_1.append(j+12*i)
  ...
  file_out_2 = directory_2 + '/' + airport_2
...
# Debería haber cantidad de años-1 
  ...
  plt.plot(x_1, cancelaciones1, 'ro', 
           ...
           linestyle='-',
           color='b',
           label=u"Cancelaciones por mes " + airport_1)

  plt.plot(x_2, cancelaciones2, 'ro', 
           alpha=opacity,
           linestyle='-',
           color='r',
           label=u"Cancelaciones por mes " + airport_2)
  ...
  plt.legend()
  plt.savefig(directory_1 + '/graficos/grafico_cancelaciones_mes_' + airport_1 + '_' + airport_2)
  plt.show()
  ...
  if cancelation_code != '':
    ...
    if cancelation_code == 'A':
      ...
      fig = directory_1 + '/graficos/grafico_cancelaciones_carrier_mes' + airport_1 + '_' + airport_2

    if cancelation_code == 'B':
      lab = "Cancelaciones de clima por mes"
      fig = directory_1 + '/graficos/grafico_cancelaciones_clima_mes' + airport_1 + '_' + airport_2

    if cancelation_code == 'C':
      lab = "Cancelaciones de NAS por mes"
      fig = directory_1 + '/graficos/grafico_cancelaciones_NAS_mes' + airport_1 + '_' + airport_2

    if cancelation_code == 'D':
      lab = "Cancelaciones de seguridad por mes"
      fig = directory_1 + '/graficos/grafico_cancelaciones_seguridad_mes' + airport_1 + '_' + airport_2

    for i in range(1, years_1-3):
      plt.axvline(x=12*i, linewidth=2, color='k')
